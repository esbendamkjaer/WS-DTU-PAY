Feature: Report feature
  ...
  Scenario: Generate a report for a merchant
    Given a merchant with name "Hubert jensen" with CPR number "0987654390" and bank account balance 1500 kr
    When the merchant requests a report
    Then the merchant should see a report containing amount of money transferred and tokens used